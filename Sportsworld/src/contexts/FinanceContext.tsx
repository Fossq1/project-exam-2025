...
*/
  ...
  const applyPurchase = async (financeId: number, price: number) => {
    ...
    const response = await FinanceService.updateFinance(
      financeId,
      updatedFinance
    );
  ...
  /*
       Values and functions that will be available through FinanceContext
   */
  ...
  /*
       Makes financeContext.Provider available for all its child components.
   */
