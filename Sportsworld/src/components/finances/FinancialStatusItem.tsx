...
// Each finance components represents a row from finance table.
  ...
  return (
    <tr className="border-b border-white/5 text-s font-bold text-white">
      ...
      <td className="py-3 pr-6">
        {finance.moneySpent.toLocaleString("nb-NO")} $
      </td>
      <td className="py-3 pr-6">
        {finance.moneyLeft.toLocaleString("nb-NO")} $
      </td>
      <td className="py-3 pr-6">
        {finance.numberOfPurchases.toLocaleString("nb-NO")}
      </td>
    </tr>
  );
};
