...
//Financial status component from the finance-page. Displays a table with current financial status.

const FinancialStatusTable = () => {
  // get finance data from financeContext
        ...
        <table className="min-w-full border-collapse">
          <thead>
            <tr className="border-b border-white/10 text-left text-s uppercase tracking-wide text-white/60">
              ...
              <th className="py-3 pr-6">Money Spent</th>
              <th className="py-3 pr-6">Remaining Budget</th>
              <th className="py-3 pr-6">Athletes Purchased</th>
            </tr>
          </thead>
